...
public class MahasiswaDeleteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText editTextNimHapus = (EditText)findViewById(R.id.editTextHapus);
        ...
        btnHapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<DefaultResult> call = service.delete_mhs(
                        editTextNimHapus.getText().toString(),"72180234"
                );
                call.enqueue(new Callback<DefaultResult>() {
                    @Override
                    public void onResponse(Call<DefaultResult> call, Response<DefaultResult> response) {
                        pd.dismiss();
                        Toast.makeText(MahasiswaDeleteActivity.this, "Data Terhapus", Toast.LENGTH_LONG).show();
                    }
                    @Override
